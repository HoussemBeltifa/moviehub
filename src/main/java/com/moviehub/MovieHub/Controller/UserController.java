...
import com.moviehub.MovieHub.Models.*;
...
public class UserController {
    ...
    @GetMapping("/{userId}/favorite-animes")
    public ResponseEntity<Set<Movie>> getUserFavoriteAnimes(@PathVariable Long userId) {
        Set<Movie> favoriteAnimes = userService.getUserFavoritemovies(userId);

        if (favoriteAnimes != null) {
            return new ResponseEntity<>(favoriteAnimes, HttpStatus.OK);
        } else {
